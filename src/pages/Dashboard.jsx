...
export const Dashboard = ({ user }) => {
  ...
  return (
    <>
      <div className="w-full max-w-[1600px] mx-auto min-h-[calc(100vh-80px)] flex flex-col gap-6 bg-[#0d111c] p-6 pb-[140px]">
        {/* GRIGLIA PRINCIPALE A 3 COLONNE */}
        <div className="grid grid-cols-[320px_1fr_320px] items-stretch gap-6 flex-1">
          ...
          <div className="flex flex-col gap-6 text-gray-200 w-full">
            ...
            <div className={`rounded-2xl flex flex-col flex-1 ${cardStyleClass}`}>
          ...
          {/* 2. COLONNA CENTRALE - SPACCATURA MATEMATICA CON GAP */}
        ...
        {/* DECISION LOG FOOTER - FULL WIDTH */}
        <div className={`w-full rounded-2xl ${cardStyleClass}`}>
          <TileDecisionLog isAdmin={isAdmin} isHorizontal={true} />
        </div>
